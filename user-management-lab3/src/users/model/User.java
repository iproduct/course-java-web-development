...
public class User implements Serializable, PermissionChangeListenable {
	...
	private boolean active; // boolean that is true if the User is enabled and active;
	...
	private Set<Permission> permissions = new HashSet<>(); // Userprivatespecific permissions overriding those provided
															// by Role collection;
	// salutation; readonly String property printed by the system when the User is
	// loggedprivatein;
	...
	private List<PermissionChangeListener> permissionChangeListeners = new CopyOnWriteArrayList<>();
