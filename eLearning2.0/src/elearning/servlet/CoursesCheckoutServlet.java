 ...
 */
@WebServlet("/WEB-INF/view/CoursesCheckoutServlet")
public class CoursesCheckoutServlet extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request,
		...
		out.println("<html><head><title>Courses Checkout</title></head><body>");
		out.println("<h1>Welcome, " + session.getAttribute("currentUser") + "</h1>");
		out.println("<h2>Please checkout selected courses:</h2>");
