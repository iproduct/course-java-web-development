...
public class AddProductDialog extends JDialog {
	...
	public AddProductDialog(JFrame topFrame, IPTInvoicingClient parent) {
		...
		btnAdd.addActionListener(ev -> {
			...
			if(parent.getServer() != null) {
				try {
					item = parent.getServer().addItem(item);
					JOptionPane.showMessageDialog(this, 
							"Product was successfully added: " + item.getName(),
							"Product Successfully Added", JOptionPane.INFORMATION_MESSAGE);
					clearFormFields();
					dispose();
					...
					JOptionPane.showMessageDialog(this, 
							"Error sending product to the server. Product NOT added.",
